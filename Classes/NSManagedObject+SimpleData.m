...
//    NSInteger index = 0;
//    for (NSDictionary *dict in sortedNewObjects)
//    {
//        NSLog(@"NEW %ld // %ld",[dict[key]integerValue],index);
//        
//        index++;
//    }
//    index = 0;
//    for (NSObject *doc in results)
//    {
//        NSLog(@"BASE %ld // %ld",[[doc valueForKey:dbKey]integerValue],index);
//        index++;
//    }
